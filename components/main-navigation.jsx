  ...
  return (
    <nav className={styles.main_nav_container}>
      ...
      <ul className={styles.nav_list}>
        ...
        <button
          className={`${styles.nav_cta_appointment} ${styles.nav_cta} ${styles.hidden_on_desktop}`}
        >
          Book Appointment
        </button>
        <button
          className={`${styles.hidden_on_desktop}`}
          onClick={() => toggleMenu()}
        >
      ...
      <div className={styles.nav_cta_container}>
        <button
          className={`${styles.nav_cta_contact} ${styles.nav_cta} ${styles.hide_at_mobile}`}
        >
          <p>Contact Us</p>
          <IoMdPlayCircle size={20} />
        </button>
        <button
          className={`${styles.nav_cta_appointment} ${styles.nav_cta} ${styles.hide_at_mobile}`}
        >
          Book Appointment
        </button>
      </div>
